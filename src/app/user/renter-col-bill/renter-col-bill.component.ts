...
export class RenterColBillComponent implements OnInit {
  ...
  bills: COLBill[];;
  bill: COLBill;
  displayedColumns: string[] = ['colId', 'placeId', 'dateCollect', "deadLineStatus", 'totalExpense', 'paymentStatusName', 'button', "paypal"];
  dataSource: any;
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort: MatSort;
  constructor(private billService: CostOfLivingBillService,
